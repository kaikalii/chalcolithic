...
$execute if items entity @s weapon.$(equipment_hand) #chalc:not_enchantable run return run title @s actionbar {"text": "You don't know how to enchant this item", color: aqua}
