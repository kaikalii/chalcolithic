...
# Cannot use mending on certain items
execute store success score #temp chalc run data get storage chalc:macro enchant.enchantments.minecraft:mending
$execute if score #temp chalc matches 1 if items entity @s $(equipment_hand) #chalc:mending_not_allowed run return run function chalc:do_nothing
