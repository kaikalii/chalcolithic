...
scoreboard players set #medium chalc.level_req 10
scoreboard players set #high chalc.level_req 30
scoreboard players set #very_high chalc.level_req 40
scoreboard players set #max chalc.level_req 50
